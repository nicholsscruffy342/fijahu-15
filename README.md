...
5. Follow the prompts to install fijahu-15 on your computer.
...
## ⚙️ How to Use fijahu-15
1. **Launch the Application:** After installing, find the fijahu-15 icon on your desktop or in your applications menu. Double-click to open it.
2. **Create a New Project:** Click on "New Project" to start a new JavaScript project. You can name your project and choose a location on your computer.
3. **Edit Code:** Use the built-in editor to write your JavaScript code. You can save your changes by clicking "File" then "Save."
4. **Run Your Code:** To see how your code works, click the "Run" button. The application will execute your JavaScript, and you will see the output in the console.

## 📚 Features
- **User-Friendly Interface:** Designed for ease of use. You don’t need to be a programmer to navigate the app.
- **Code Editor:** A simple code editor that supports JavaScript syntax.
- **Console Output:** Quickly see the output of your code with a built-in console.
